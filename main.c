...
int main(int argc, char *argv[]) {
  ...
  while (running) {
    ...
    switch (byte) {
    case 0x00: // NOP
      if (debug) printf("PC: 0x%04X\t0x%02X\t%s\n", regs[PC].full, byte, "NOP");
      ++cycle;
      break;
    // case 0x01: // LD BC, n16
    // {
